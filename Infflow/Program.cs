...
namespace Infflow
{
    ...
    class CamHub : PixelArtCamera
    {
        ...
        public override void Update()
        {
            ...
            if (Engine.InputManager.GetMouseScrollRelative() < 0) Zoom += 0.01f * Zoom * Engine.DeltaTime;
            if (Engine.InputManager.GetMouseScrollRelative() > 0) Zoom -= 0.01f * Zoom * Engine.DeltaTime;
            ...
            // Initial speed is MooveSpeed, factored by the zoom to avoid uneaven feeling movement when zoom is @ extremum
            float speed = MoveSpeed / Zoom;
